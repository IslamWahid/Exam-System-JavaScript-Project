var IQExamObj = {
    ...
    Quests: [
        ...
        {
            head: "find the pair that has a similar relationship.\nDEPRESSED : SAD",
            answers: [" neat : considerate", " towering : cringing", " rapid : plodding", " progressive : regressive", " exhausted : tired"],
            correctAnswer: 0,
            grade: 1
        },
        {
            head: "find the pair that has a similar relationship.\nCOTTON : BALE",
            answers: [" butter : churn", " wine : ferment", " grain : shock", " curd : cheese", " beef : steak"],
            correctAnswer: 1,
            grade: 1
        },
        {
            head: "find the pair that has a similar relationship.\nFINCH : BIRD",
            answers: [" frog : toad", " elephant : reptile", " Dalmatian : dog", " collie : marsupial", " ant : ladybug"],
            correctAnswer: 3,
            grade: 1
        }
    ]
...
window.addEventListener("load", function() {
    ...
    btnFinish.addEventListener("click", function() {
        ...
        if (currentExamObj == ExamArr[ExamArr.length - 1]) {  // last exam
            ...
            currentExamObj.Quests = shuffleQuestArr(currentExamObj.Quests).slice(0,currentExamObj.maxQuesNum);
